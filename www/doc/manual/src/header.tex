...
\newcommand{\apibrowser}{http://openacs-dotlrn.wu-wien.ac.at/api-doc}
\newcommand{\xotcl}{http://media.wu-wien.ac.at/langRef-xotcl.html}
\newcommand{\apilink}[3]{\href{\apibrowser/proc-view?proc=#1+#2+#3}{#1\begin{math}\rightarrow\end{math}#3}}
