...
instantiating \objlink{::xorb::stub::ProxyObject} and thus creating a proxy object (\objlink{::xorb::stub::ProxyObject} might be resolved as 'G
...
For a detailed description see \proclink{::xorb::ProxyObject}{instproc}{ad\_proc}.
