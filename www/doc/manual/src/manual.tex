...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=6,lastline=10]{../examples/xosoap/example-01-soap-consumer.tcl}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=16,lastline=21]{../examples/xosoap/example-01-soap-consumer.tcl}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=5,lastline=9]{../examples/xosoap/example-02-soap-consumer.tcl}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=12,lastline=18]{../examples/xosoap/example-02-soap-consumer.tcl}
\item Finally, once the above is done, you can continue by issuing the call, i.e. invoke on the 'remote' method:
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=21,lastline=21]{../examples/xosoap/example-02-soap-consumer.tcl}
\end{enumerate}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=26,lastline=26]{../examples/xosoap/example-03-soap-consumer.tcl}
  \end{enumerate}
At this level, stub (or proxy) methods appear in their purest forms as mere placeholders for remote calls realising a local representation of a remote (object) interface. Please note that declarations by means of glue/ ad\_glue don't take a method body as they are mere interface descriptors. This makes them syntactically comparable to the \xotclref{Object-abstract}{abstract keyword} that comes with XOTcl to mimic abstract classes. However, do not align them at the semantic level.
  \begin{figure}[htbp]
\begin{center}
...
The \emph{high-level interface}, as can been seen from Figure \ref{fig:advanced:interface:1}, is a purely protocol plug-in-specific one. As for xosoap, we provide two intregating idioms: ::xosoap::client::SoapObject and ::xosoap::client::SoapClass inherit and expose and combine properties of glue objects and proxy clients in one. This allows for an abbreviated and compact writing of SOAP client code, with all facilities introduced by lower interface levels. For an introductory example see the quick start section on xosoap (see Section \ref{sec:quickstart:xosoap}) and, in particular, Listing \ref{lst:quickstart:xosoap:3}.
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=16,lastline=28]{../examples/xosoap/example-04-soap-consumer.tcl}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=16,lastline=34]{../examples/xosoap/example-05-soap-consumer.tcl}
...
\lstinputlisting[breaklines=true,numbers=left,frame=single,basicstyle=\footnotesize,firstline=37,lastline=41]{../examples/xosoap/example-05-soap-consumer.tcl}
...
\end{itemize}
 ...
 \lstinputlisting[breaklines=true,numbers=left,label=lst:quickstart:xosoap:2,frame=single,basicstyle=\footnotesize,caption=A simple SOAP client]{../examples/xosoap/example-01-soap-consumer.tcl}
  \lstinputlisting[breaklines=true,numbers=left,label=lst:quickstart:xosoap:3,frame=single,basicstyle=\footnotesize,caption=An even simpler SOAP client]{../examples/xosoap/example-02-soap-consumer.tcl}
...
%        \href{http://media.wu-wien.ac.at/download/README-xotcl-core}{http://media.wu-wien.ac.at/download/README-xotcl-core}. 
...
%            \item
%            \href{http://media.wu-wien.ac.at/download/acs-api-documentation-procs.patch}{acs-api-documentation-procs.patch}
%            \item
%            \href{http://media.wu-wien.ac.at/download/acs-bootstrap-installer.patch}{acs-bootstrap-installer.patch}
%          \end{itemize}
...
%  more precise.\footnote{Please refer to the mixin-section of the \href{http://media.wu-wien.ac.at/doc/tutorial.html#mixins}{XOTcl
