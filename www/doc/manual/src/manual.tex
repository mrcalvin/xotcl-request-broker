...
For a detailed description see \apilink{::xorb::GObject}{instproc}{ad\_proc}.
%\href{http://openacs-dotlrn.wu-wien.ac.at/api-doc/proc-view?proc=::xorb::GObject+instproc+ad_proc}{::xorb::GObject->ad\_proc}.
\item Invoke the proxy method to perform the remote call
\lstinputlisting[breaklines=true,numbers=left,label=lst:quickstart:xosoap:1,frame=single,basicstyle=\footnotesize,firstline=24,lastline=24]{../examples/xosoap/example-01-soap-consumer.tcl}
\end{enumerate}
